...
<br/>
<h5>Paso 1: RESPUESTA INDIVIDUAL</h5>
</div>
<div class="text-center alert-text" id="title">
<h5>@lang('labels.msg_tap_correct_answer')</h5>
</div>

<div class="circle-wrapper">
<div class="circle">
<img class="img-circle" id="img-circle" src="">
<button id="ansA" class="btn-cir ans1">A</button>
<button id="ansB" class="btn-cir ans2">B</button>
<button id="ansC" class="btn-cir ans3">C</button>
<button id="ansD" class="btn-cir ans4">D</button>
<button id="ansE" class="btn-cir ans5">E</button>
...
<div id="modal-team" class="modal" role="dialog">
  <div class="modal-dialog">
    <div class="modal-wrapper">
      <div class="modal-content modal-body">
		<button type="button" class="close" data-dismiss="modal">&times;</button>
...
$(document).ready(function(){
	...
	var ansltr = ['A','B','C','D','E'];
	var colors = ['r01z.png', 'r02z.png', 'r03z.png', 'r04z.png', 'r05z.png'];
	var grays = ['r01z_gray.png', 'r02z_gray.png', 'r03z_gray.png', 'r04z_gray.png', 'r05z_gray.png'];
