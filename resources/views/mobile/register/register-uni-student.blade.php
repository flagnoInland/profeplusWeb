...
$('#register').validate({
    submitHandler: function(form) {
        $.post( "",
		{
			...
			institution_name : $("#institution").val()
		},
		function(data, status) {
			var userid = data['user_id'];
			window.location.replace("{{ url('web/board') }}"+'/'+userid+'/1/0000/0');		
    ...
    messages: {
		...
		dni: {
			required: "Ingrese su número de D.N.I."
		},
		birthdate: {
		...
		studentid: {
			required: "Ingrese su código de estudiante"
		},
		terms :{
			required: ""
		}
